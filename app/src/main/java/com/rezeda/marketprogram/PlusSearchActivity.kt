...
import com.rezeda.marketprogram.adapters.PlusAdapter
import com.rezeda.marketprogram.models.ProductList

class PlusSearchActivity : AppCompatActivity() {

lateinit var all_products: RecyclerView
lateinit var search_product: SearchView
lateinit var productAdapter: PlusAdapter
...
override fun onCreate(savedInstanceState: Bundle?) {
    ...
    if (product_list_JSON!=null) {
        ...
        productAdapter = PlusAdapter(product_list_new, this)
        ...
        productAdapter = PlusAdapter(product_list, this)
