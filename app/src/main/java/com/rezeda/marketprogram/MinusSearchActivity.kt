...
import com.rezeda.marketprogram.adapters.MinusAdapter
import com.rezeda.marketprogram.models.ProductList

class MinusSearchActivity : AppCompatActivity() {

    lateinit var all_products: RecyclerView
    lateinit var search_product: SearchView
    lateinit var productAdapter: MinusAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var product_list = arrayListOf<ProductList>()
        ...
        if (product_list_JSON!=null) {
            ...
            productAdapter = MinusAdapter(product_list_new, this)
            ...
            productAdapter = MinusAdapter(product_list, this)
