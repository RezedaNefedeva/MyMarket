...
class MinusAdapter (private var products: MutableList<ProductList>?, private var context: Context) :
    RecyclerView.Adapter<MinusAdapter.MyViewHolder>() {
...
//            notifyDataSetChanged()
//        }
        holder.itemView.setOnClickListener { val intent = Intent(context, MinusAmount::class.java)
