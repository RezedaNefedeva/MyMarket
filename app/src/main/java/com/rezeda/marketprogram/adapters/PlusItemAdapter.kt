...
class PlusItemAdapter (private var saleList: MutableList<SaleItem>?, private var context: Context) :
    RecyclerView.Adapter<PlusItemAdapter.MyViewHolder>() {
        ...
        holder.sale_delete.setOnClickListener {
            ...
            AlertDialog.Builder(context)
                ...
                .setPositiveButton("Удалить"){
                    ...
                    if(saleList!!.size == 0){
                        PlusAmount.total_price_plus = 0.0f
                        PlusAmount.total.text = SalePage.total_price.toString()
                    } else {
                        PlusAmount.total_price_plus -= saleList!![position].summa
                        PlusAmount.total.text = SalePage.total_price.toString()
                    }
