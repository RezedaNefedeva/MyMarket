...
class ProductListAdapter(private var products: MutableList<ProductList>?, private var context: Context) :
...
//            notifyDataSetChanged()
//        }
        holder.itemView.setOnClickListener { val intent = Intent(context, SalePage::class.java)
